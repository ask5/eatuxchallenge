child_earning_sources = [
    ...
    {
        'id': 3,
        'name': 'Income from persons outside the household'
    },
    {
        'id': 4,
...
adult_earning_sources = [
    ...
    {
        'id': 2,
        'name': 'Public Assistance/Alimony/Child Support'
    },
    {
        'id': 3,
        'name': 'U.S. Military'
    ...
    {
        'id': 4,
        'name': 'Pensions/Retirement/All Other Income'
    }
]
