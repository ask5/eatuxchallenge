...
urlpatterns = [
    ...
    url(r'^app/children/(?P<child_id>[0-9]+)/salary', views.child_salary, name='child_salary'),
    url(r'^app/children/(?P<child_id>[0-9]+)/social_security_income', views.child_social_security_income,
        name='child_social_security_income'),
    url(r'^app/children/(?P<child_id>[0-9]+)/parent_social_security_income', views.parent_social_security_income,
        name='parent_social_security_income'),
    url(r'^app/children/(?P<child_id>[0-9]+)/spending_money_income', views.spending_money_income,
        name='spending_money_income'),
    url(r'^app/children/(?P<child_id>[0-9]+)/other_friend_income', views.other_friend_income,
        name='other_friend_income'),
    url(r'^app/children/(?P<child_id>[0-9]+)/pension_income', views.pension_income,
        name='pension_income'),
    url(r'^app/children/(?P<child_id>[0-9]+)/annuity_income', views.annuity_income,
        name='annuity_income'),
    url(r'^app/children/(?P<child_id>[0-9]+)/trust_income', views.trust_income,
        name='trust_income'),
    url(r'^app/children/(?P<child_id>[0-9]+)/other_income', views.other_income,
        name='other_income'),
